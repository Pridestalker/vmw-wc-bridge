...
function activate_vmw_wc() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-vmw-wc-activator.php';
...
function deactivate_vmw_wc() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-vmw-wc-deactivator.php';
...
function run_vmw_wc() {
	...
	require_once __DIR__ . '/class-vmw-wc-autoloader.php';
