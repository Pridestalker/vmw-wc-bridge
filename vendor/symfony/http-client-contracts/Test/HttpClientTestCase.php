...
abstract class HttpClientTestCase extends TestCase
{
    ...
    public function testConditionalBuffering()
    {
        ...
        $response = $client->request(
            'GET', 'http://localhost:8057', ['buffer' => function () {
                return false; 
            }]
        );
        $response->getContent();
    ...
    public function testReentrantBufferCallback()
    {
        ...
        $response = $client->request(
            'GET', 'http://localhost:8057', ['buffer' => function () use (&$response) {
                $response->cancel();
    ...
    public function testRedirects()
    {
        ...
        $filteredHeaders = array_values(
            array_filter(
                $response->getInfo('response_headers'), function ($h) {
    ...
    public function testRelativeRedirects()
    {
        ...
        $response = $client->request(
            'GET', 'http://localhost:8057/302/relative', [
            'max_redirects' => 0,
            ]
        );
    ...
    public function testOnProgressCancel()
    {
        $client = $this->getHttpClient(__FUNCTION__);
        $response = $client->request(
            'GET', 'http://localhost:8057/timeout-body', [
    ...
    public function testNotATimeout()
    {
        $client = $this->getHttpClient(__FUNCTION__);
        $response = $client->request(
            'GET', 'http://localhost:8057/timeout-header', [
            'timeout' => 0.9,
            ]
        );
        sleep(1);
    ...
    public function testMaxDuration()
    {
        $client = $this->getHttpClient(__FUNCTION__);
        $response = $client->request(
            'GET', 'http://localhost:8057/max-duration', [
            'max_duration' => 0.1,
            ]
        );
