    ...
    protected function getHttpClient(string $testCase): HttpClientInterface
    {
        ...
        default:
            return new MockHttpClient(
                function (string $method, string $url, array $options) use ($client) {
                    try {
        ...
        case 'testResolve':
            ...
            $responses[] = new MockResponse(
                (function () {
                    throw new \Exception('Fake connection timeout'); yield ''; 
        ...
        case 'testInformationalResponseStream':
            ...
            $response = new MockResponse(
                'Here the body', ['response_headers' => [
                'HTTP/1.1 103 ',
            ...
            $client->method('stream')->willReturn(
                new ResponseStream(
